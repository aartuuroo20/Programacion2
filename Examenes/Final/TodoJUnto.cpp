...
public:
    ...
    Contacto(string nom,string apell,string telef,string gmail, string fecha){
        setNombre(nom);
        setApellido1(apell);
        setTelefono(telef);
        setEmail(gmail);
...
public:
    ...
    void borrar(string nomb_,string apell);
...
void Agenda::borrar(string nomb_, string apell)
{
